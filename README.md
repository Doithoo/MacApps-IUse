...
- **个人使用优先**：这里的选择来自我的实际使用，不追求覆盖所有优秀软件。
- **推荐不等于唯一最佳**：某个软件能留下来，说明它在我的场景里长期解决了问题。
- **持续变化**：当工作流、审美或软件质量变化时，清单也会调整。
- **链接优先指向可信来源**：尽量使用官网、GitHub、App Store 或开发者维护的下载页。

## 我如何选择软件

我通常会用这些标准判断一款软件是否值得保留：

- 它解决一个真实且反复出现的问题。
- 它在 macOS 上足够顺手，尊重系统习惯和桌面体验。
- 它稳定到可以进入日常工作流，而不是只适合尝鲜。
- 它有可接受的维护状态、商业模式或长期可信度。
- 它不是因为热门才留下，而是因为我确实愿意继续用。
...
这份清单欢迎修正错误，但不接受纯推广和批量软件收录。

- 如果你发现链接失效、名称错误或描述不准确，欢迎提交 issue 或 PR。
- 如果你想推荐新软件，请说明它解决的具体问题，以及你长期使用后的体验。
- 是否收录最终取决于我是否愿意在自己的 Mac 工作流中继续使用它。
